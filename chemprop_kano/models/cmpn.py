...
class CMPNEncoder(nn.Module):
    ...
    def forward_atom_embed(self, step, mol_graph: BatchMolGraph, features_batch=None) -> torch.Tensor:
        ...
        device: torch.device = f_atoms.device
    ...
    def forward(self, step, mol_graph: BatchMolGraph, features_batch=None) -> torch.FloatTensor:
        f_atoms, f_bonds, a2b, b2a, b2revb, a_scope, atom_num, fg_num, f_fgs, fg_scope = mol_graph.get_components()
        atom_hiddens = self.forward_atom_embed(step, mol_graph, features_batch)
